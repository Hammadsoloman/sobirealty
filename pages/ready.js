...
export default function Ready() {
  return (
    <>
      <NextSeo
        title="Join Us | SOBIREALTY"
        description="Join Us | SOBIREALTY"
      />
      <Box as="main" bg={"#00A3EE"}>
        <Container as={"section"} maxW={"4xl"} py={32}>
          <Heading2>Are you SOBIREALTY. ready?</Heading2>
          <Paragraph color={"white"}>
            If you are interested in joining the greatest real estate brokerage
            in the history of the world, fill out the form below so we can get
